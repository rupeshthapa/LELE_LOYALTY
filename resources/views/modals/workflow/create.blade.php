<div class="modal fade" id="addWorkflowModal" aria-labelledby="workflowModalLabel" aria-hidden="true" data-bs-backdrop="static">
    ...
    <div class="modal-content">
      <form id="createWorkflowForm" enctype="multipart/form-data">
        ...
        <div class="modal-header">
          ...
          <button type="button" class="btn-close" id="workflowCloseBtn" data-bs-dismiss="modal" aria-label="Close"></button>
        </div>
        ...
        <div class="modal-footer">
          ...
          <button type="button" class="btn btn-secondary" data-bs-dismiss="modal" id="workflowCancelBtn">Cancel</button>
        </div>
      </form>
    </div>
  </div>
