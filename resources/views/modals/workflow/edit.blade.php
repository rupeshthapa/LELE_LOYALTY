<div class="modal fade" id="editWorkflowModal" aria-labelledby="edit_workflowModalLabel" aria-hidden="true" data-bs-backdrop="static">
    ...
    <div class="modal-content">
      <form id="editWorkflowForm" enctype="multipart/form-data">
        ...
        <div class="modal-header">
          ...
          <button type="button" class="btn-close" id="edit_workflowCloseBtn" data-bs-dismiss="modal" aria-label="Close"></button>
        </div>
        ...
        <div class="modal-footer">
          ...
          <button type="button" class="btn btn-secondary" data-bs-dismiss="modal" id="edit_workflowCancelBtn">Cancel</button>
        </div>
      </form>
