<div class="modal fade" id="editProjectModal" aria-labelledby="projectModalLabel" aria-hidden="true"
        ...
        <div class="modal-content">
            <form id="editProjectForm" enctype="multipart/form-data">
                ...
                <div class="modal-header">
                    ...
                    <button type="button" class="btn-close" id="projectCloseBtn" data-bs-dismiss="modal"
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        ...
                        <img id="editLogoPreview" src="" class="img-thumbnail mb-2"
                    ...
                    <div class="mb-3" id="editProjectUrlDiv">
                        ...
                        <input type="url" class="form-control" id="edit_url_id" name="url"
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-secondary" data-bs-dismiss="modal"
                        id="projectCancelBtn">Cancel</button>
                </div>
            </form>
        </div>
    </div>
