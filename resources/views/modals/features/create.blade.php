<div class="modal fade" id="addFeatureModal" aria-labelledby="featureModalLabel" aria-hidden="true" data-bs-backdrop="static">
    ...
    <div class="modal-content">
      <form id="createFeatureForm" enctype="multipart/form-data">
        ...
        <div class="modal-header">
          ...
          <button type="button" class="btn-close" id="featureCloseBtn" data-bs-dismiss="modal" aria-label="Close"></button>
        </div>
        ...
        <div class="modal-footer">
          ...
          <button type="button" class="btn btn-secondary" data-bs-dismiss="modal" id="cancelFeatureBtn">Cancel</button>
        </div>
      </form>
    </div>
  </div>
