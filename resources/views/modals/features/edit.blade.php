<div class="modal fade" id="editFeatureModal" aria-labelledby="editFeatureModalLabel" aria-hidden="true"
        ...
        <div class="modal-content">
            <form id="editFeatureForm" enctype="multipart/form-data">
                ...
                <div class="modal-header">
                    ...
                    <button type="button" class="btn-close" id="editFeatureCloseBtn" data-bs-dismiss="modal"
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-3" id="editFeatureImageDiv">
                        ...
                        <input type="file" class="form-control" id="editFeature_image" name="image"
                            accept="image/*">
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-secondary" data-bs-dismiss="modal"
                        id="editCancelFeatureBtn">Cancel</button>
                </div>
            </form>
        </div>
    </div>
