    ...
    <div class="modal-content">
      <form id="editLoyaltyForm" enctype="multipart/form-data">
        ...
        <div class="modal-header">
          ...
          <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close" id="loyalty_editCloseBtn"></button>
        </div>
        ...
        <div class="modal-footer">
          ...
          <button type="button" class="btn btn-secondary" data-bs-dismiss="modal" id="loyalty_editCancelBtn">Cancel</button>
        </div>
      </form>
    </div>
  </div>
