<div class="modal fade" id="addLoyaltyModal" aria-labelledby="LoyaltyModalLabel" aria-hidden="true" data-bs-backdrop="static">
    ...
    <div class="modal-content">
      <form id="createLoyaltyForm" enctype="multipart/form-data">
        ...
        <div class="modal-header">
          ...
          <button type="button" class="btn-close" id="loyaltyCloseBtn" data-bs-dismiss="modal" aria-label="Close"></button>
        </div>
        ...
        <div class="modal-footer">
          ...
          <button type="button" class="btn btn-secondary" data-bs-dismiss="modal" id="loyaltyCancelBtn">Cancel</button>
        </div>
      </form>
    </div>
  </div>
