<div class="modal fade" id="editOfficeModal" aria-labelledby="editOfficeModalLabel" aria-hidden="true" data-bs-backdrop="static">
    ...
    <div class="modal-content">
      <form id="editOfficeForm" enctype="multipart/form-data">
        ...
        <div class="modal-header">
          ...
          <button type="button" class="btn-close" id="editOfficeCloseBtn" data-bs-dismiss="modal" aria-label="Close"></button>
        </div>
        ...
        <div class="modal-body">
          ...
          <div class="mb-3" id="editOfficeIconDiv">
            <label for="edit_office_icon" class="form-label">Icon (FontAwesome class e.g. <code>fas fa-building</code>)</label>
        ...
        <div class="modal-footer">
          ...
          <button type="button" class="btn btn-secondary" data-bs-dismiss="modal" id="editOfficeCancelBtn">Cancel</button>
        </div>
      </form>
    </div>
  </div>
