    ...
    <div class="modal-content">
      <form id="createOfficeForm" enctype="multipart/form-data">
        ...
        <div class="modal-header">
          ...
          <button type="button" class="btn-close" id="officeCloseBtn" data-bs-dismiss="modal" aria-label="Close"></button>
        </div>
        ...
        <div class="modal-body">
          ...
          <div class="mb-3" id="officeIconDiv">
            <label for="office_icon" class="form-label">Icon (FontAwesome class e.g. <code>fas fa-building</code>)</label>
        ...
        <div class="modal-footer">
          ...
          <button type="button" class="btn btn-secondary" data-bs-dismiss="modal" id="officeCancelBtn">Cancel</button>
        </div>
      </form>
    </div>
  </div>
