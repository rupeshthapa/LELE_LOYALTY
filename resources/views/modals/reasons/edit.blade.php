<div class="modal fade" id="editReasonModal" aria-labelledby="editReasonModalLabel" aria-hidden="true"
        ...
        <div class="modal-content">
            <form id="editReasonForm" enctype="multipart/form-data">
                ...
                <div class="modal-header">
                    ...
                    <button type="button" class="btn-close" id="reasonCloseBtn" data-bs-dismiss="modal"
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        ...
                        <img id="editIconPreview" src="" class="img-thumbnail mb-2"
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-secondary" data-bs-dismiss="modal"
                        id="edit_reasonCancelBtn">Cancel</button>
                </div>
