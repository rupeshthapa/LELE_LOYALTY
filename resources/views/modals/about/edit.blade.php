    ...
    <div class="modal-content">
      <form id="editAboutForm" enctype="multipart/form-data">
        ...
        <div class="modal-header">
          ...
          <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close" id="about_editCloseBtn"></button>
        </div>
        ...
        <div class="modal-footer">
          ...
          <button type="button" class="btn btn-secondary" data-bs-dismiss="modal" id="about_editCancelBtn">Cancel</button>
        </div>
      </form>
    </div>
  </div>
