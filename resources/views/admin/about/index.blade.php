                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-end">
                                ...
                                <li class="breadcrumb-item active" aria-current="page"><i class="fas fa-question-circle me-1"></i> About</li>
                            </ol>
                        </div>
                    </div>
                    <!--end::Row-->
            ...
            $('#aboutTable').DataTable({
                ...
                columns: [
                    ...
                    if (xhr.status === 422) {
                        ...
                        if (errors.description) {
                            $('#about_editDescriptionError').text(errors.description[0]).show();
