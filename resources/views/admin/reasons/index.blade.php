            ...
            <div class="row">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-end">
                        ...
                        <li class="breadcrumb-item active" aria-current="page"><i class="fas fa-brain me-1"></i> Reasons
                        </li>
                    </ol>
                </div>
            </div>
            ...
            $(document).on('click', '.edit-reason', function() {
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        if (response.icon) {
                            $('#editIconPreview').attr("src", `/storage/${response.icon}`)
                            .show();
                        } else {
                ...
                $.ajax({
                    ...
                    error: function(xhr) {
                        if (xhr.status === 422) {
                            ...
                            if (errors.description) {
                                $('#edit_reasonDescriptionError').text(errors.description[0])
                                    .show();
