                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-end">
                                ...
                                <li class="breadcrumb-item active" aria-current="page"><i class="fas fa-tools me-1"></i> Features</li>
                            </ol>
                        </div>
                    </div>
                    <!--end::Row-->
...
@push('scripts')
    ...
    $('#createFeatureForm').on('submit', function (e) {
      ...
      $('#featureTitleError, #featureDescriptionError, #featureClassError, #imageClassError, #featureImageError').text('').hide();
      $('#feature_title, #feature_description, #feature_class, #image_class, #feature_image').removeClass('is-invalid');
        ...
        error: function (xhr) {
          if (xhr.status === 422) {
            ...
            if (errors.description) {
              $('#featureDescriptionError').text(errors.description[0]).show();
...
// Sync image_class based on editFeature_class selection, keep hidden input updated
            ...
            $('#editFeatureForm').on('submit', function(e){
                ...
                $('#editFeatureTitleError, #editFeatureDescriptionError, #editFeatureClassError, #editImageClassError, #editFeatureImageError').text('').hide();
                $('#editFeature_title, #editFeature_description, #editFeature_class, #edit_image_class, #editFeature_image').removeClass('is-invalid');
                ...
                $.ajax({
                    ...
                    error: function(xhr){
                        if(xhr.status === 422){
                            ...
                            if(errors.description){
                                $('#editFeatureDescriptionError').text(errors.description[0]).show();
