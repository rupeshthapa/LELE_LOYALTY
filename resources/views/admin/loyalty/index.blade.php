                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-end">
                                ...
                                <li class="breadcrumb-item active" aria-current="page"><i class="fas fa-certificate me-1"></i> Loyalty</li>
                            </ol>
                        </div>
                    </div>
                    <!--end::Row-->
            ...
            error: function (xhr) {
                if (xhr.status === 422) {
                    ...
                    if (errors.description) {
                        $('#loyaltyDescriptionError').text(errors.description[0]).show();
            ...
            success: function(response){
                ...
                if(response.image){
                    ...
                    $.ajax({
                        ...
                        if (errors.description) {
                            $('#loyalty_editDescriptionError').text(errors.description[0]).show();
