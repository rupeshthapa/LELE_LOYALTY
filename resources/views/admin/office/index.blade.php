            ...
            <div class="row">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-end">
                        ...
                        <li class="breadcrumb-item active" aria-current="page"><i class="fas fa-briefcase me-1"></i> Office
                        </li>
                    </ol>
                </div>
            </div>
            ...
            $('#editOfficeForm').on('submit', function(e) {
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        'hide'); // use modal('hide') instead of .hide()
                        $('#officeTable').DataTable().ajax.reload();
                    },
                    error: function(xhr) {
                        if (xhr.status === 422) {
                            ...
                            if (errors.description) {
                                $('#editOfficeDescriptionError').text(errors.description[0])
                                    .show();
