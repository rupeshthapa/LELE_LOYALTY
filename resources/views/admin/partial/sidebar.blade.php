<div class="app-sidebar-wrapper"
    style="position: fixed; top: 0; left: 0; height: 100vh; width: 250px; z-index: 1030; transition: transform 0.3s ease-in-out;">
    <aside class="app-sidebar bg-body-secondary shadow d-flex flex-column" data-bs-theme="dark"
        ...
        <div class="sidebar-brand">
            <a href="{{ route('admin.dashboard.index') }}" class="brand-link">
                <img src="{{ asset('storage/customerloyalty.png') }}" alt="Lele Logo" class="opacity-75 shadow"
        ...
        <div class="sb-sidenav-footer p-2 border-top"
            style="margin-top: 1rem; background-color: rgba(0, 0, 0, 0.2); color: #fff;">
